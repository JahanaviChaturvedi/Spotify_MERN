...
export function LogosSpotify(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
...
const SignupComponent = () => {
  ...
  const signUp = async () => {
    if (email !== confirmEmail) {
      alert("Email and confrim email fields must match. Please check again");
      return;
    }
  ...
  return (
    <div className="w-full h-full flex flex-col items-center">
      <div className="logo border-b border-solid border-gray-400 w-full flex justify-center">
        <LogosSpotify width="150" />
      </div>
      <div className="inputRegion w-1/1 py-10 flex items-center justify-center flex-col">
        ...
        <div className="my-5 font-semibold text-ld">
